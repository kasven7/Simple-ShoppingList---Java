...
public class Product {
    ...
    // (opcjonalnie) konstruktor do tworzenia obiektu-rekordu
    ...
    private void createTable() {
        try (Statement stmt = conn.createStatement()) {
            ...
            // 3) jeśli pusta, dodaj przykładowe rekordy
            if (isEmpty) {
    ...
    // Wariant prosty: zwraca same nazwy (najłatwiej pod UI listy)
    public List<String> getAllNamesByCategoryId(int categoryId) {
        List<String> result = new ArrayList<>();
        String sql = "SELECT name FROM product WHERE category_id=" + categoryId + " ORDER BY created_at DESC";
    ...
    // Wariant “pełne rekordy”: zwraca listę Product (przyda się do JTable)
    ...
    public int updateName(int productId, String newName) {
        String sql = "UPDATE product SET name='" + newName + "' WHERE id=" + productId;
    ...
    // --- Gettery (żeby JTable/TableModel mógł czytać pola) ---
